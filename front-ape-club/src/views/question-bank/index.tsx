...
const QuestionBank = () => {
  ...
  return (
    <div className={styles['question-bank']}>
      <div className={styles['question-bank__main']} onScroll={scrollHandler}>
        <div className={styles['question-bank__content']}>
          <div className={styles['question-bank__category']}>
            <CategoryList onChangeLabel={onChangeLabel} />
          </div>
          <div className={styles['question-bank__list']}>
            <QuestionList
              pageIndex={pageIndex}
              total={total}
          ...
          <div className={styles['question-bank__loading']}>
      ...
      <div className={styles['question-bank__sidebar']}>
        <ContributionList />
        <PracticeList />
      </div>
    </div>

...
const BrushQuestions = () => {
  ...
  const labelNames = question?.labelName || question?.labelNames || []
  const answerHtml = question?.subjectAnswer || question?.subjectParse || ''
      ...
      {question ? (
        <Fragment>
          <div className='question-content'>
            <div className='difficulty'>{grade[question.subjectDifficult]}-{labelNames.join('、')}</div>
